  ...
  <div id="app">
    <div id="nav">
      ...
      <main>
          ...
          <section id="cards-aside" class="pt-5 pb-5">
        <div class="container">
            <!-- Section Title -->
            <div class="row">
                <h2 class="pb-5">Latest Articles</h2>
            </div>
                ...
                <!-- card column-->
                    ...
                    <!--implementation of cards with card grid, 3 cols for xl, 2 for mds and 1 for rest-->
                        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3">
                            ...
                            <div class="col mb-4">
                                <div class="card">
                                    <img src="assets/images/essential-wordpress-security-list.png" class="card-img-top" alt="...">
                                    <div class="card-body">
                            ...
                            <div class="col mb-4">
                                <div class="card">
                                    <img src="assets/images/how-to-ssh-into-your-server.png" class="card-img-top" alt="...">
                                    <div class="card-body">
                            ...
                            <div class="col mb-4">
                                <div class="card">
                                    <img src="assets/images/secure-your-joomla-installation.png" class="card-img-top" alt="...">
                                    <div class="card-body">
                            ...
                            <div class="col mb-4">
                                <div class="card">
                                    <img src="assets/images/tips-to-supercharge-your-seo.png" class="card-img-top" alt="...">
                                    <div class="card-body">
